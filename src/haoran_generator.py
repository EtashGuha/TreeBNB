...
if __name__ == '__main__':
    ...
    if args.problem == 'setcover':
        ...
        n = 20
        nrows = 200
        lp_dir = f'../data/instances/setcover/transfer_{nrows}r_{ncols}c_{dens}d_{max_coef}mc_{args.seed}se'
        print(f"{n} instances in {lp_dir}")
        if not os.path.exists(lp_dir):
            os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        ...
        # train instances
        n = 50
        lp_dir = f'data/instances/indset/train_{number_of_nodes}_{affinity}_{args.seed}se'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        ...
        # validation instances
        n = 20
        lp_dir = f'data/instances/indset/valid_{number_of_nodes}_{affinity}_{args.seed}se'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nnodess.extend([number_of_nodes] * n)
        ...
        # n = 10
        # number_of_nodes = 750
        # lp_dir = f'data/instances/indset/transfer_{number_of_nodes}_{affinity}_{args.seed}se'
        # print(f"{n} instances in {lp_dir}")
        # os.makedirs(lp_dir)
        # filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        # nnodess.extend([number_of_nodes] * n)
        ...
        n = 10
        number_of_nodes = 500
        lp_dir = f'data/instances/indset/test_{number_of_nodes}_{affinity}_{args.seed}se'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nnodess.extend([number_of_nodes] * n)
